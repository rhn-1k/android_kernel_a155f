...
#define REAR3_GC02M1_MAX_CAL_SIZE                (0x0759 + 0x1)

#define REAR3_GC02M1_HEADER_CHECKSUM_LEN        (0x00FB + 0x1)
#define REAR3_GC02M1_OEM_CHECKSUM_LEN           (0x010B - 0x0100 + 0x1)
#define REAR3_GC02M1_AWB_CHECKSUM_LEN           (0x011B - 0x0110 + 0x1)
#define REAR3_GC02M1_SHADING_CHECKSUM_LEN       (0x051B - 0x0120 + 0x1)

#define REAR3_GC02M1_CONVERTED_MAX_CAL_SIZE     (0x0AB9 + 0x1)
#define REAR3_GC02M1_CONVERTED_AWB_CHECKSUM_LEN (0x011B - 0x0110 + 0x1)
#define REAR3_GC02M1_CONVERTED_LSC_CHECKSUM_LEN (0x087B - 0x0120 + 0x1)
...
const struct imgsensor_vendor_rom_addr rear3_gc02m1_cal_addr = {
	...
	.rom_header_main_mtf_data_addr          = 0x522, // It must be in af area, not in factory area in cal data
	...
	.rom_shading_checksum_addr              = 0x051C,
